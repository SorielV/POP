    ...
    `<div class="col-12">
	    <div class="row">
	      ...
	      <div class="col-9 col-sm-9">
	      	<div class="row">	
		        <div class="col" v-text="comment.content">
		        </div>
...
Vue.component('post', {
	template: 
		`<div class="card news-card view">
      <div class="card-body">
          <div class="content">
              <div class="right-side-meta">14 h
              	<div class="float-right" v-if="post.username == username">
	  							<a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false"></a>
			  						<div class="dropdown-menu">
			    						<a class="dropdown-item" @click="update">Editar</a>
			     						<a class="dropdown-item" @click="remove">Borrar</a>
										</div>
								</div>
              </div>
              ...
              <a :href="'/profile/' + post.username">
              	<span v-text="post.username"></span>
              </a>
          </div>
      </div>
      ...
      <div class="card-body mid">
        <div class="social-meta">
            ...
            <p>
            	...
            	</a><span v-text="count"></span> Comentarios
            </p>
        </div>
        <div class="md-form end">
        		...
        		<div class="row d-flex flex-wrap">	
        			<div class="">	
        				<img class="float-right rem rounded-circle z-depth-1-half" style="margin: 0.5rem;" :src="'/img/user/' + username + '.png'" onerror="this.src = '/img/user/default.png'">
        			</div>
        			<div class="col"> 	
...
Vue.component('posts', {
	template: 
		`<div v-if="!error">
			<div class="card">
       	<h6 class="card-header elegant-color-dark white-text">Crear Publicacion</h6>
          <div class="card-body">                            
            <div class="row">
              <form class="col-12" v-on:submit.prevent="createPost">
              	<div v-if="static !== false" class="md-form">
              		<select v-model="post.project" class="form-control" required="true">
									...
									<label class="enable">Proyecto</label>
                </div>
                ...
                <div class="container d-flex justify-content-center">
                  <button type="submit" class="btn special-color-dark">Crear Publicacion</button>
                </div>
              </form>
            </div>
          </div>    
					    ...
					    <div class="modal-dialog modal-notify modal-danger" role="document">
					      <div class="modal-content">
					        <div class="modal-header">
					          <p class="heading lead">Editar Publicacion</p>
					        ...
					        <div class="modal-body">
					          <form class="col-12" v-on:submit.prevent="updatePost">
					            ...
					            <button type="submit" class="btn btn-primary-modal">Actualizar <i class="fa fa"></i></button>
					            <button type="button" class="btn btn-outline-secondary-modal waves-effect" data-dismiss="modal">Cancelar</button>
					          </form>
					        </div>
					      </div>
					    </div>
