			    ...
			    <div class="modal-content">
			      <form action="/project" method="post">
			        ...
			        <div class="modal-body mb-0">
		              ...
		              <input type="text" id="f1" name="title" v-model="project.title" class="form-control" placeholder="Project Name" required>
			          </div>

			          <div class="md-form">
		              <i class="fa fa-tags prefix" aria-hidden="true"></i>
		              <input type="text" class="form-control" id="for6" name="tag" v-model="project.tag" placeholder="Project Tags" required>
			          </div>
		              ...
		              <input class="form-control" name="img" v-model="project.img" type="url" value="" id="img" placeholder="Project Image" required>
			          </div>

			          <div class="text-center mt-1-half">
		              <button type="submit" class="btn btn-info mb-2 waves-effect waves-light">
		                <i class="fa fa-send ml-1">Update</i>
		              </button>
			          </div>
			        </div>
			      </form>
