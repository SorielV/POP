Vue.component('comment', {
    ...
    `<div class="col-12">
	    <div class="row">
	      <div class="col-2">
	        <div class="chip">
	          <img :src="'/img/user/' + comment.username + '.png'" onerror="this.src = '/img/user/default.png'" class="">
              ...
              <form class="col-12" v-on:submit.prevent="createPost">
                ...
                <div class="container col-9">
                	<div class="row">
		                ...
		                <div class="col">
		                  <button type="submit" class="btn special-color-dark btn-block p-2 text-center">Crear</button>
		                </div>
		              </div>
	              </div>
              </form>
